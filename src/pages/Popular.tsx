  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-display font-medium mb-2 text-blue-800">Popular Crochet Items</h1>
        <p className="text-blue-600 mb-8">Our most loved crochet items chosen by our customers</p>
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-12 bg-blue-50 rounded-lg">
            ...
            <p className="text-blue-500">Products added to the "Popular Crochet" category will appear here.</p>
          </div>
        )}
