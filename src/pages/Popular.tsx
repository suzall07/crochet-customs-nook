  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-medium mb-2 text-blue-800">Popular Crochet Items</h1>
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">Products added to the "Popular Crochet" category will appear here.</p>
          </div>
        )}
