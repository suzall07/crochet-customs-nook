    ...
    <div className="min-h-screen pt-24 pb-16">
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-display font-medium mb-6 text-center text-black">About Crochet with Limboo</h1>
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-display font-medium mb-6 text-center text-black">Frequently Asked Questions</h2>
            
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 className="font-medium text-xl mb-2 text-black">How long does it take to make a custom order?</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <h3 className="font-medium text-xl mb-2 text-black">Do you ship internationally?</h3>
                <p className="text-gray-700">
